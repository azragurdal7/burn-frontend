...
const styles = {
    ...
    backArrow: { padding: "11px 10px", backgroundColor: "#7ba9db", color: "white", border: "none", borderRadius: "5px", cursor: "pointer", fontWeight: "bold", fontSize: "16px" },
    ...
    recordButton: { padding: "8px", backgroundColor: "#7ba9db", color: "white", border: "none", borderRadius: "50%", cursor: "pointer", fontSize: "18px", width: "40px", height: "40px", display: "flex", alignItems: "center", justifyContent: "center", transition: "background-color 0.2s" }, // Buton küçültüldü
